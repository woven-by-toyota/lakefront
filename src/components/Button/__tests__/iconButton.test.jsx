...
describe('getIconStyles', () => {
    ...
    it('returns the correct styles when alternate is false', () => {
        ...
        expect(getIconStyles({ theme: THEME, alternate: false }).destructive.styles).toContain('border:1px solid #c0392b;min-width:0;height:48px;width:48px;border-radius:100%;:hover{background-color:#ef5042;span{color:#ef5042;}}');
    ...
    it('returns the correct styles when alternate is true', () => {
        ...
        expect(getIconStyles({ theme: THEME, alternate: true }).destructive.styles).toContain('border:1px solid #c0392b;min-width:0;height:48px;width:48px;border-radius:100%;:hover{background-color:#d53628;span{color:#d53628;}}');
